    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.html"><img src="img/bool-logo-sml.png"></a>
            </div>
            ...
            <div class="header-content-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <h2><a href="../index.jsp" class="btn btn-primary btn-block page-scroll">Login</a></h2>
                        <h3><a href="../index.jsp" class="btn btn-primary btn-block page-scroll">Continue as Guest</a></h3>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    </div>
    ...
    <section class="no-padding" id="portfolio">
        <div class="container-fluid">
            <div class="row no-gutter popup-gallery">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/3.png" class="portfolio-box">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/4.png" class="portfolio-box">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="img/portfolio/fullsize/6.png" class="portfolio-box">
